...
export default function PshPanel() {
    ...
    <div className="w-full bg-white min-h-screen pb-2 overflow-x-hidden">
      <div className="sticky top-0 z-10 bg-white border-b border-gray-200 px-3 sm:px-4 py-3 shadow-sm">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 max-w-[1400px] mx-auto">
          <h1 className="text-lg sm:text-xl font-semibold text-black">PSH (Past Surgical History)</h1>
      ...
      <div className="px-2 sm:px-2 md:px-2 py-3 sm:py-2 max-w-[1400px] mx-auto">
        <div className="border border-blue-300 rounded-xl p-2 sm:p-2 bg-white shadow-sm">
          <div className="flex justify-between items-center mb-3">
            <div className="flex items-center gap-2"><Stethoscope size={16} className="text-blue-600" /><span className="text-xs font-semibold text-black">PSH Entries</span></div>
            <Tooltip text="Add new entry" position="right"><button onClick={addRow} className="bg-blue-500 hover:bg-blue-600 text-white px-2 sm:px-3 py-1 rounded text-[10px] sm:text-xs font-bold flex items-center gap-1"><Plus size={12} /> ADD</button></Tooltip>
          </div>
